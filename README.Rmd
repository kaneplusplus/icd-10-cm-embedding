...
knitr::kable(x, caption = "The autoencoder parameters and performance ordered by decreasing validation loss.")
```
...
As a reminder, the goal in presenting these results is not to necessarily to 
maximize the prediction accuracy. It is to show that the embedding retains the
...
for at least some of the conditions might be considered arbitrary.
Based on this criteria, we can conclude the embedding does retain much of the 
structural and conceptual information denoted in the descriptions.
